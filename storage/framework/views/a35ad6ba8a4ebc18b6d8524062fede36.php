<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($label && !$inline): ?>
        <label for="<?php echo e($uuid); ?>" class="pt-0 label label-text font-semibold"><?php echo e($label); ?></label>
    ...
    <!--[if BLOCK]><![endif]--><?php if($prefix || $prepend): ?>
        <div class="rounded-l-lg flex items-center bg-base-200 <?php if($prefix): ?> border border-primary border-r-0 px-4 <?php endif; ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'absolute top-1/2 right-3 -translate-y-1/2 text-gray-400 pointer-events-none']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalce0070e6ae017cca68172d0230e44821)): ?>
<?php $component = $__componentOriginalce0070e6ae017cca68172d0230e44821; ?>
...
<?php endif; ?>
        ...
        <!-- INLINE LABEL -->
        <!--[if BLOCK]><![endif]--><?php if($label && $inline): ?>
            <label for="<?php echo e($uuid); ?>" class="absolute text-gray-400 duration-300 transform -translate-y-1 scale-75 top-2 origin-[0] rounded bg-base-100 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-1 <?php if($inline && $icon): ?> left-9 <?php else: ?> left-3 <?php endif; ?>">
                <?php echo e($label); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($suffix || $append): ?>
        <div class="rounded-r-lg flex items-center bg-base-200 <?php if($suffix): ?> border border-primary border-l-0 px-4 <?php endif; ?>">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /var/www/finpal/storage/framework/views/e569961efa134c0bd74cae36b5fa27c7.blade.php ENDPATH**/ ?>