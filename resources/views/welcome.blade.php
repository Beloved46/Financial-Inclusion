        ...
        <div class="hero min-h-screen bg-neutral-content">
            <div class="hero-content flex-col lg:flex-row-reverse">
                <div class="card flex-shrink-0 w-full shadow-2xl bg-base-500">
                    <form class="card-body">
                      <div class="form-control">
                        ...
                        <a class="btn btn-primary mb-4" href="{{ route('login') }}">Sign in</a>
                      </div>
                      <div class="form-control">
                       
                        <a class="btn btn-outline btn-primary" href="{{ route('register') }}">Create Account</a>
              ...
              <div class="text-center lg:text-left">
                {{-- <h1 class="text-5xl font-bold">Welcome To MoneyMinder</h1>
